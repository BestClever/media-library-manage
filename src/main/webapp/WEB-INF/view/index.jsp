...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-header header">
        <div class="layui-main mag0">
            <a href="#" class="logo">媒体管理系统</a>
            <!-- 显示/隐藏菜单 -->
            <a href="javascript:;" class="seraph hideMenu icon-caidan"></a>
            <!-- 顶部右侧菜单 -->
            <ul class="layui-nav top_menu">
                <li class="layui-nav-item" pc>
                    <a href="javascript:;"><i class="layui-icon" data-icon="&#xe640;">&#xe60e;</i><span
                            id="time"></span></a>
                </li>
                <%--<li class="layui-nav-item" id="userInfo">--%>
                <%--<a href="javascript:;"><cite class="adminName"><span>hello</span></cite></a>--%>
                <%--<dl class="layui-nav-child">--%>
                <%--<dd><a href="javascript:;" data-url=""><i class="seraph icon-ziliao"--%>
                <%--data-icon="icon-ziliao"></i><cite>个人资料</cite></a>--%>
                <%--</dd>--%>

                <%--<dd><a href="" class="signOut"><i--%>
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="${baseurl}/images/meiti.jpg" class="userAvatar"></a>
            <%--<p>你好！<span>hello</span>, 欢迎登录</p>--%>
        </div>

        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${baseurl}/main"><i class="layui-icon"
...
<script type="text/javascript">
    ...
    layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
        ...
        tab = layui.bodyTab({
            ...
            url: BaseUrl + "/json/nav.json"//获取菜单json地址
        });
