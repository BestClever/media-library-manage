    ...
    <form class="layui-form">
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="videoTitle" placeholder="请输入搜索的内容"/>
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" name="videoId" placeholder="请输入搜索的内容"/>
            </div>
        </div>
...
<script>
    layui.use(["element", "jquery", "table", "form", "laydate"], function () {
        ...
        var talbeInstance = table.render({
            ...
            size: "sm",
            cols: [[
                {field: "videoId", title: "编号"},
                {field: "videoTitle", title: "标题"},
                {field: "bookAuthor", title: "作者"},
                {field: "videoLevel", title: "评级", templet: "#levelTpl"},
                {field: "producerName", title: "出品者的名字"},
                {field: "producerYear", title: "出品年份"},
                {field: "videoTime", title: "视频时长"},
        ...
        function del(data) {
            ...
            layer.confirm('您是是否确认删除？', {
                ...
                $.post(BaseUrl+'video/delete', params, function (result) {
                    if (result.success) {
